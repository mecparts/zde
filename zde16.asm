			...
			;Rename to ZDE16.Z80 for ZASM (Cromemco ASMB)
;	.Z80		;Uncomment these two lines and rename
;	ASEG		;to ZDE16.MAC for M80
			;(use RELHEX to convert ZDE16.REL to ZDE16.HEX)
;
...
;		[----5----10---15---20---25--]
VersID:	DB	'ZDE 1.6, Copr. 1990 C.Wilson',0
;
;
